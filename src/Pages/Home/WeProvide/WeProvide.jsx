      ...
      <div className="w-full mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="card w-96 bg-base-100 shadow-xl">
          <figure className="px-10 pt-10">
            <img
              src="https://i.ibb.co/jkkGZy0/kelly-sikkema-OG9p-Ie51rh-U-unsplash.jpg"
              alt="Shoes"
        ...
        <div className="card w-96 bg-base-100 shadow-xl">
          <figure className="px-10 pt-10">
            <img
              src="https://i.ibb.co/fvSXGJ0/kelli-tungay-2-LJ4rq-K2qf-U-unsplash.jpg"
              alt="Shoes"
              className="rounded-xl"
            />
          </figure>
        ...
        <div className="card w-96 bg-base-100 shadow-xl">
          <figure className="px-10 pt-10">
            <img
              src="https://i.ibb.co/LYqv99m/raychan-k-JQ6c-Dyod-AM-unsplash.jpg"
              alt="Shoes"
              className="rounded-xl"
            />
          </figure>
        ...
        <div className="card w-96 bg-base-100 shadow-xl">
          <figure className="px-10 pt-10">
            <img
              src="https://i.ibb.co/zmyqQF4/steve-johnson-vcoc8e9-Wbi-A-unsplash.jpg"
              alt="Shoes"
              className="rounded-xl"
            />
          </figure>
        ...
        <div className="card w-96 bg-base-100 shadow-xl">
          <figure className="px-10 pt-10">
            <img
              src="https://i.ibb.co/XFYSmzv/kelly-sikkema-10-AH6f-V6-Iz8-unsplash.jpg"
              alt="Shoes"
              className="rounded-xl"
            />
          </figure>
